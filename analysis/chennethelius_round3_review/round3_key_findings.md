...
- `v19_vfe_mr_3000`: Round 3 v11 — Kevin's hybrid.py + ONLY VFE informed-flow target bias. KEY FINDING: at limit=200/300 (the IMC actual limits), hybrid.py historical PnL = 716,008. v01-v10 all add layers (Stoikov skew, dual-anchor MR, IV scalp, exit-at-fair, EMA trend) on top of hybrid's v + Features: kalman_mean_reversion, microprice_fair, informed_flow, inventory_aware, ema_trend, vev_divergence_mm, full_limits_focus.

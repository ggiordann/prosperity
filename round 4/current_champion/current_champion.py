...
class Logger:
    ...
    def truncate(self, v116, v117):
        ...
        return v31
v0 = Logger()
v1 = {'prefix': 'hp', 'symbol': 'HYDROGEL_PACK', 'limit': 200, 'fair': 10002, 'stdev_init': 33.0, 'var_alpha': 0.005, 'qsize': 35, 'flat_pull': 1.0, 'mr_thresh': 4, 'mr_boost': 1.5, 'z_min': 0.7, 'z_max': 2.0, 'ema_fast': 0.3, 'ema_slow': 0.05, 'ema_vslow': 0.02, 'ema_full': 1.5, 'informed_lookback': 8, 'informed_full': 30, 'w_z': 0.5, 'w_ema': 0.3, 'w_inf': 0.2, 'take_max': 80, 'take_offset': 4, 'base_cap_pct': 0.5, 'full_cap_pct': 1.0, 'hard_cap_pct': 0.95, 'mark_weights': {'Mark 14': +1.5, 'Mark 38': -1.0}}
v2 = {'prefix': 'vfe', 'symbol': 'VELVETFRUIT_EXTRACT', 'limit': 200, 'fair': 5251, 'stdev_init': 17.0, 'var_alpha': 0.005, 'qsize': 30, 'flat_pull': 1.0, 'mr_thresh': 3, 'mr_boost': 1.5, 'z_min': 0.7, 'z_max': 2.0, 'ema_fast': 0.3, 'ema_slow': 0.05, 'ema_vslow': 0.02, 'ema_full': 0.8, 'informed_lookback': 10, 'informed_full': 40, 'w_z': 0.5, 'w_ema': 0.3, 'w_inf': 0.2, 'take_max': 70, 'take_offset': 3, 'base_cap_pct': 0.5, 'full_cap_pct': 1.0, 'hard_cap_pct': 0.95, 'mark_weights': {'Mark 67': +1.5, 'Mark 49': -1.5, 'Mark 22': -1.0, 'Mark 14': -0.5, 'Mark 55': +0.5}}
v3 = [{'symbol': 'VEV_4000', 'strike': 4000, 'limit': 300, 'soft_cap': 250, 'soft_cap_max': 300, 'offset': 2}, {'symbol': 'VEV_4500', 'strike': 4500, 'limit': 300, 'soft_cap': 250, 'soft_cap_max': 300, 'offset': 2}, {'symbol': 'VEV_5000', 'strike': 5000, 'limit': 300, 'soft_cap': 200, 'soft_cap_max': 250, 'offset': 8}, {'symbol': 'VEV_5100', 'strike': 5100, 'limit': 300, 'soft_cap': 150, 'soft_cap_max': 180, 'offset': 18}, {'symbol': 'VEV_5200', 'strike': 5200, 'limit': 300, 'soft_cap': 100, 'soft_cap_max': 130, 'offset': 38}, {'symbol': 'VEV_5300', 'strike': 5300, 'limit': 300, 'soft_cap': 80, 'soft_cap_max': 100, 'offset': 90}]
v4 = 2

def _conviction_signals(v92, v102, v91, v106, v70):
    ...
    v27 = min(1.0, abs(v25) / v70['informed_full']) if v26 != 0 and v26 == v17 else 0.0
    v28 = 0.0 if v16 == 0.0 else v70['w_z'] * v16 + v70['w_ema'] * v57 + v70['w_inf'] * v27
...
def _conviction_orders_with_extension(v92, v102, v91, v106, v70, v107, v108):
    v29 = _conviction_signals(v92, v102, v91, v106, v70)
    if v29 is None:
        return []
    v5 = v29['bb']
    v6 = v29['ba']

...
class Trader:
    LIMIT = 10
    MM_PRODUCTS = set(['SLEEP_POD_NYLON', 'MICROCHIP_OVAL', 'PEBBLES_S', 'UV_VISOR_ORANGE', 'UV_VISOR_RED', 'TRANSLATOR_ASTRO_BLACK', 'TRANSLATOR_VOID_BLUE', 'PANEL_2X2', 'PANEL_1X4', 'PANEL_2X4', 'OXYGEN_SHAKE_MORNING_BREATH', 'OXYGEN_SHAKE_EVENING_BREATH', 'OXYGEN_SHAKE_CHOCOLATE', 'SNACKPACK_CHOCOLATE', 'SNACKPACK_PISTACHIO', 'SNACKPACK_STRAWBERRY', 'SNACKPACK_RASPBERRY'])
    QUOTE_SIZE = 10
    IMPROVE = 2
    MIN_EDGE = 1.0
    INV_SKEW = 0.0

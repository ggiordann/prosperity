...
class Trader:
    ...
    Design:
    - ASH_COATED_OSMIUM: stable around a slow long-term moving average near
      ~10_000. Market-make around that adaptive anchor with inventory skew and
      take stale quotes.

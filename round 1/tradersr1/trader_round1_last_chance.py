...
class Trader:
    ...
    Design:
    - ASH_COATED_OSMIUM: stable around ~10_000.
      Market-make around a fixed anchor with inventory skew and take stale quotes.
      This version is deliberately more active in ASH while keeping the logic simple.

    - INTARIAN_PEPPER_ROOT: persistent upward drift.
      Keep the stronger, already-proven aggressive accumulation logic from the
      earlier high-scoring revision.
    """
